...
<body>
	...
	<div>
	<iframe style="float:left;align-items:center;height:50vw;width:50vw;" src="CS-web designing template.html"></iframe>
	<iframe style="margin-let:60%;margin-right:0;align-items:center;height:50vw;width:48vw;" src="template2.html"></iframe>
</div>
<br><br><br><br><br>
	<footer id="contact">
