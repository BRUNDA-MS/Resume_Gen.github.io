...
<body>
	...
	<div>
	<iframe style="float:left;align-items:center;height:50vw;width:50vw;" src="templates/mechtemp.html"></iframe>
	<iframe style="margin-let:60%;margin-right:0;align-items:center;height:50vw;width:48vw;" src="templates/mech1temp.html"></iframe>
</div>
