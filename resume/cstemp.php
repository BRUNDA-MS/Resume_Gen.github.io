...
<body>
	...
	<div class="topnav" style="list-style: none;" id="navbarNavDropdown">
        ...
        ?>
				  ...
				  <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" style="background-color: black;">
					<a class="dropdown-item" href="customtemp.php">My Templates</a>
	...
	<div>
	<iframe style="float:left;align-items:center;height:50vw;width:50vw;" src="templates/CS-web designing template.html"></iframe>
	<iframe style="margin-let:60%;margin-right:0;align-items:center;height:50vw;width:48vw;" src="templates/template2.html"></iframe>
</div>
<br><br><br><br><br>
	<footer id="contact">
