...
.myDiv {
  ...
  overflow: hidden;
    ...
    <br><br><br><br><br>
    <div>
    <h1 style="color:white;margin-left:30%;font-family:'Times New Roman', Times, serif; font-size: 3vw;"> View your Custom Templates here</h1>
	<br><br><br><br>
	<div class="myDiv"><?php 
                $var= $_SESSION['email'];
                $query = "select * from templates WHERE email='$var'";
                $result = mysqli_query($con,$query);
...
<br><br><Br><br><Br>
		<footer id="contact">
		<p style="color:white;margin-left:24%;font-family:'Times New Roman', Times, serif; font-size: 3vw;">Follow us on social media for more updates</p>
		<ul>
